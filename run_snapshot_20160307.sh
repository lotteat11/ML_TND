#!/bin/bash
# =============================================================================
# run_snapshot_20160307.sh — warm-start snapshot for the off-track map
#
...
# one. runs_final_20250821 holds a snapshot for 2016-02-18 only, and that day
# is a mediocre showcase: it ranks 241 of 491 post-2016 days by skill gain
# (-27.7%), despite being genuinely disturbed (ap 67).
#
# 2016-03-07 is the best disturbed day in the whole post-2016 holdout:
# ap 94, MSIS 0.405 -> model 0.182, a -55.0% gain.
#
# This run reproduces dr1_post2016_h1 with EVERY setting identical to
# runs_final_20250821 except the snapshot date, and writes to its own output
# root so the reported results are not touched. Only the snapshot is wanted;
# the metrics it produces should reproduce the reported ones.
#
# Usage:  ./run_snapshot_20160307.sh
# =============================================================================
set -euo pipefail
cd "$(dirname "$0")"
...
export ONTRACK_SNAPSHOT_POST2016="2016-03-07"
...
export ONTRACK_OUTPUT_ROOT="runs_snapshot_20160307"
